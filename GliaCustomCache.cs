    ...
    public class GliaLastValueCacheCustom
    {
        ...
        private void readChannel()
        {
            ...
            if (transportMessage != null)
            {
                ...
                if (LastTransportValues[MessageTypes.ABI_MESSAGE_HEART_RATE] != null && OnHeartRate != null)
                {
                    OnHeartRate.Invoke(m_connection.Build<HeartRate>(LastTransportValues[MessageTypes.ABI_MESSAGE_HEART_RATE]));
                }
            }
        }
        ...
        public HeartRate? GetEyeData()
        {
            lock (TransportArrayLock)
            {
                if (LastTransportValues[MessageTypes.ABI_MESSAGE_HEART_RATE] != null)
                    return m_connection.Build<HeartRate>(LastTransportValues[MessageTypes.ABI_MESSAGE_HEART_RATE]);
            }
            return default;
        }
    }
